...
namespace CRISP.Tests.Resilience;
...
public class CompositeResilienceStrategyTests
{
    ...
    public async Task Execute_WithCircuitBreakerAndTimeout_TimeoutExceededException()
    {
        ...
        // Act
        Func<Task<int>> act = async () => await compositeStrategy.Execute(async ct =>
        {
    ...
    public async Task Execute_WithCircuitBreakerThatOpens_ThrowsCircuitBreakerOpenException()
    {
        ...
        // Act
        callCount = 0;
        Func<Task<int>> act = async () => await compositeStrategy.Execute(ct =>
        {
            callCount++;
    ...
    public async Task Execute_WithRetryAndCircuitBreaker_AllRetriesFailAndCircuitOpensPreventing_FurtherCalls()
    {
        ...
        Func<Task<int>> act = async () => await compositeStrategy2.Execute(ct =>
        {
            callCounts.Add(DateTime.Now);
            return new ValueTask<int>(42);
        }, CancellationToken.None);
    ...
    public async Task Execute_WithMultipleStrategies_AppliesStrategiesInOrder()
    {
        ...
        mockStrategy1.Setup(s => s.Execute(It.IsAny<Func<CancellationToken, ValueTask<int>>>(),
        ...
        mockStrategy2.Setup(s => s.Execute(It.IsAny<Func<CancellationToken, ValueTask<int>>>(),
                It.IsAny<CancellationToken>()))
            .Returns<Func<CancellationToken, ValueTask<int>>, CancellationToken>(
        ...
        // Act
        int result = await strategy.Execute(ct => ValueTask.FromResult(10), CancellationToken.None);
        ...
        mockStrategy1.Verify(s => s.Execute(It.IsAny<Func<CancellationToken, ValueTask<int>>>(),
                It.IsAny<CancellationToken>()),
            Times.Once);
        mockStrategy2.Verify(s => s.Execute(It.IsAny<Func<CancellationToken, ValueTask<int>>>(),
                It.IsAny<CancellationToken>()),
            Times.Once);
    }
    ...
    public async Task Execute_RealisticComposition_AppliesAllStrategies()
    {
        ...
        int result = await compositeStrategy.Execute(_ => ValueTask.FromResult(42), CancellationToken.None);
    ...
    public async Task Execute_WithTimeoutExceedingLimit_ThrowsTimeoutException()
    {
        ...
        Func<Task<int>> act = async () => await compositeStrategy.Execute(async _ =>
        {
    ...
    public async Task Execute_WithCancellationToken_PropagatesCancellation()
    {
        ...
        // Act
        Func<Task<int>> act = async () => await compositeStrategy.Execute(_ =>
