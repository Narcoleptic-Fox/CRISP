...
public interface IEventDispatcher
{
    ...
    ValueTask Dispatch(IDomainEvent @event, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A value task representing the asynchronous operation.</returns>
    ValueTask DispatchAll(IEnumerable<IDomainEvent> events, CancellationToken cancellationToken = default);
}